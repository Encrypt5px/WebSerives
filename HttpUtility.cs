...
namespace WebSerives
{
    ...
    public class HttpUtility
    {
        ...
        static public string UrlDecode(string value, Encoding encoding)
        {
            if (value == null)
            {
                return null;
        ...
        public static string HtmlEncode(string value)
        {
            ...
            System.IO.StringWriter output = new System.IO.StringWriter(System.Globalization.CultureInfo.InvariantCulture);
            HtmlEncode(value, output);
            return output.ToString();
        }

        public static unsafe void HtmlEncode(string value, System.IO.TextWriter output)
        {
            if (value != null)
            {
                if (output == null)
                ...
                else
                {
                    ...
                    fixed (char* str = (value.ToCharArray()))
                    {
                        ...
                        while (num2-- > 0)
                        {
                            ...
                            {
                                output.Write("&#");
                                output.Write(ch.ToString(System.Globalization.NumberFormatInfo.InvariantInfo));
                                output.Write(';');
                            }
                            else
                            {
